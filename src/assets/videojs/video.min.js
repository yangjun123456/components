! function (t, e) {
  ...
  var $r = function (t) {
    ...
    return De(e, t), e.prototype.buildCSSClass = function () {
      ...
      console.log('pause2');
      console.log(this);
      let id = this.player_.id_;
      document.getElementById(id).getElementsByClassName('vjs-big-play-button')[0].style.display = 'block';
      console.log('play3');
  ...
  Ri.prototype.options_ = {
    children: ["playToggle", "currentTimeDisplay", "timeDivider", "durationDisplay", "progressControl", "liveDisplay", "remainingTimeDisplay", "customControlSpacer", "playbackRateMenuButton", "chaptersButton", "descriptionsButton", "subsCapsButton", "audioTrackButton", "volumePanel", "fullscreenToggle"]
  ...
  var io = Re(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
    ...
    so = function (t) {
      ...
      return De(e, t), e.prototype.dispose = function () {
        ...
        console.log('handleTechClick_1', this);
        this.removeTechControlsListeners_(),
          // 双击全屏事件
          // this.on(this.tech_, 'dblclick', function () {
          //   this.player_.isFullscreen() ? this.player_.exitFullscreen() : this.player_.requestFullscreen()
          // }),
          this.on(this.tech_, "mousedown", this.handleTechClick_),
          this.on(this.tech_, "touchstart", this.handleTechTouchStart_), this.on(this.tech_, "touchmove", this.handleTechTouchMove_), this.on(this.tech_, "touchend", this.handleTechTouchEnd_), this.on(this.tech_, "tap", this.handleTechTap_)
      }, e.prototype.removeTechControlsListeners_ = function () {
        console.log('handleTechClick_2', this);
        this.off(this.tech_, "tap", this.handleTechTap_), this.off(this.tech_, "touchstart", this.handleTechTouchStart_), this.off(this.tech_, "touchmove", this.handleTechTouchMove_), this.off(this.tech_, "touchend", this.handleTechTouchEnd_), this.off(this.tech_, "mousedown", this.handleTechClick_)
        // , 
        // 双击退出全屏事件
        // this.off(this.tech_, 'dblclick', function () {
        //   this.player_.isFullscreen() ? this.player_.exitFullscreen() : this.player_.requestFullscreen()
        // })
        ...
        console.log('当前点击播放事件');
        let id = this.player_.id_;
        document.getElementById(id).getElementsByClassName('vjs-big-play-button')[0].style.display = 'none';
  ...
  // 添加禁止拖动进度条
  setTimeout(() => {
    console.log($('.vjs-progress-control'));
    $('#' + this.player_.id_ + ' .vjs-progress-control').append('<div style="position:absolute;left:0;top:0;z-index:9999999999999;width:100%;height:100%;" class="disabledDraggableProgressbar"></div>');

    $('#' + this.player_.id_ + ' .disabledDraggableProgressbar').mousedown(function () {
      return false;
    })
    $('#' + this.player_.id_ + ' .disabledDraggableProgressbar').mouseup(function () {
      return false;
    })
    $('#' + this.player_.id_ + ' .disabledDraggableProgressbar').mouseover(function () {
      return false;
    })
    $('#' + this.player_.id_ + ' .disabledDraggableProgressbar').mouseout(function () {
      return false;
    })
    $('#' + this.player_.id_ + ' .disabledDraggableProgressbar').mouseleave(function () {
      return false;
    })
  }, 1000);
});
